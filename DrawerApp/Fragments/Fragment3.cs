...
//using System.Json; Errors for some reason?
...
namespace DrawerApp.Fragments
{
    public class Fragment3 : Fragment
    {
        ...
        private async Task<JsonValue> FetchWeatherAsync(string url)
        {
            ...
            using (WebResponse response = await request.GetResponseAsync())
            {
                ...
                using (Stream stream = response.GetResponseStream())
                {
                    ...
                    JsonValue jsonDoc = await Task.Run(() => JsonObject.Load
                   (stream));
        ...
        // Parse the weather data, the write temperature, humidity,
        ...
        private void ParseAndDisplay(JsonValue json)
        {
            ...
            // Extract the array of the name/value results for the field name "weatherObservation".
